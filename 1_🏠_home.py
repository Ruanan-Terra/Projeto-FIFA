...
if "data" not in st.session_state:
    df_data = pd.read_csv(r'C:\Users\ruana\OneDrive\Área de Trabalho\Cursos\Asimov\Curso Streamlit\Projeto FIFA\datasets\CLEAN_FIFA23_official_data.csv', index_col=0)
...
st.sidebar.markdown("Desenvolvido durante o curso de Dashboards da Asimov Academy")

btn = st.button('Acesse meu LinkdIn!')

if btn:
    webbrowser.open_new_tab('https://www.linkedin.com/in/ruanan-terra-de-lima-88b774210/')
